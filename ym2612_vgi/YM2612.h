...
class YM2612
{
  public:
    ...
    void loadPatch ();
    void selectPatch (int value) { patch_index = value;}
    ...
    //channel params
    void setFeedback            (int chan, int value) { setChannelParameter( chan, YM_CH_FB, value);}
    void setAlgorithm           (int chan, int value) { setChannelParameter( chan, YM_CH_ALG, value);}
    void setStereo              (int chan, int value) { setChannelParameter( chan, YM_CH_L_R, value);}
    void setStereo              (int chan, int l, int r) { setStereo(chan, (l<<1)|r);}
    void setAMS                 (int chan, int value) { setChannelParameter( chan, YM_CH_AMS, value);}
    void setFMS                 (int chan, int value) { setChannelParameter( chan, YM_CH_FMS, value);}
    //operator params
    void setAmplitudeModulation (int chan, int oper, int value) { setOperatorParameter( chan, oper, YM_OP_AM, (value>0));}
    void setAttackRate          (int chan, int oper, int value) { setOperatorParameter( chan, oper, YM_OP_AR, value);}
    void setDecayRate           (int chan, int oper, int value) { setOperatorParameter( chan, oper, YM_OP_D1R, value);}
    void setSustainRate         (int chan, int oper, int value) { setOperatorParameter( chan, oper, YM_OP_D2R, value);}
    void setReleaseRate         (int chan, int oper, int value) { setOperatorParameter( chan, oper, YM_OP_RR, value);}
    void setTotalLevel          (int chan, int oper, int value) { setOperatorParameter( chan, oper, YM_OP_TL, value);}
    void setSustainLevel        (int chan, int oper, int value) { setOperatorParameter( chan, oper, YM_OP_D1L, value);}
    void setMultiply            (int chan, int oper, int value) { setOperatorParameter( chan, oper, YM_OP_MUL, value);}
    void setDetune              (int chan, int oper, int value) { setOperatorParameter( chan, oper, YM_OP_DT1, value);}
    void setRateScaling         (int chan, int oper, int value) { setOperatorParameter( chan, oper, YM_OP_RS, value);}
    void setSSG_EG              (int chan, int oper, int value) { setOperatorParameter( chan, oper, YM_OP_SSG_EG, value);}
    //shortcuts
    void setFeedback            (int value) { setFeedback(-1, value);}
    void setAlgorithm           (int value) { setAlgorithm(-1, value);}
    void setStereo              (int value) { setStereo(-1, value);}
    void setAMS                 (int value) { setAMS( -1, value);}
    void setFMS                 (int value) { setFMS(-1, value);}
    void setAmplitudeModulation (int value) { setAmplitudeModulation( -1, -1, value);}
    void setAttackRate          (int value) { setAttackRate( -1, -1, value);}
    void setDecayRate           (int value) { setDecayRate( -1, -1, value);}
    void setSustainRate         (int value) { setSustainRate( -1, -1, value);}
    void setReleaseRate         (int value) { setReleaseRate( -1, -1, value);}
    void setTotalLevel          (int value) { setTotalLevel( -1, -1, value);}
    void setSustainLevel        (int value) { setSustainLevel( -1, -1, value);}
    void setMultiply            (int value) { setMultiply( -1, -1, value);}
    void setDetune              (int value) { setDetune( -1, -1, value);}
    void setRateScaling         (int value) { setRateScaling( -1, -1, value);}
    void setSSG_EG              (int value) { setSSG_EG( -1, -1, value);}
